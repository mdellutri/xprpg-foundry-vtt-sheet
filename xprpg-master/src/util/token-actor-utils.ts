 ...
 * @returns An array of ActorXPRPG elements according to the aforementioned filters.
 */
function getSelectedOrOwnActors(types?: ActorType[], useOwnCharacter = true): ActorXPRPG[] {
