...
import { BaseItemDataXPRPG, BaseItemSourceXPRPG } from "@item/data/base";
import { Size, TraitsWithRarity, ValuesList } from "@module/data";
import type { AncestryXPRPG } from ".";

type AncestrySource = BaseItemSourceXPRPG<"ancestry", AncestrySystemSource>;

type AncestryData = Omit<AncestrySource, "system" | "effects" | "flags"> &
    BaseItemDataXPRPG<AncestryXPRPG, "ancestry", AncestrySystemData, AncestrySource>;
