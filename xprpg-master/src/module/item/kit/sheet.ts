import { CoinsXPRPG, PhysicalItemXPRPG } from "@item/physical";
...
import { KitXPRPG } from "./index";
import { UUIDUtils } from "@util/uuid-utils";

class KitSheetXPRPG extends ItemSheetXPRPG<KitXPRPG> {
    ...
    async removeItem(event: MouseEvent): Promise<KitXPRPG> {
...
interface KitSheetData extends ItemSheetDataXPRPG<KitXPRPG> {
    priceString: CoinsXPRPG;
