...
import { WeaponXPRPG } from "@item/weapon";
...
import { ConvertedNPCDamage, WeaponDamageXPRPG } from "@system/damage/weapon";
import { tupleHasValue } from "@util";
import { MeleeData, MeleeSystemData, NPCAttackTrait } from "./data";

class MeleeXPRPG extends ItemXPRPG {
    ...
    get baseDamage(): ConvertedNPCDamage {
        ...
        return WeaponDamageXPRPG.npcDamageToWeaponDamage(instance);
    }
    ...
    get linkedWeapon(): Embedded<WeaponXPRPG> | null {
        const item = this.actor?.items.get(this.flags.xprpg.linkedWeapon ?? "");
    ...
    override prepareActorData(): void {
        ...
        for (const instance of Object.values(this.system.damageRolls)) {
            try {
                ...
                console.warn(`XPRPG System | ${message}`);
                instance.damage = "1d4";
            }
...
interface MeleeXPRPG extends ItemXPRPG {
