...
import { RuleElementXPRPG, RuleElementSource } from "@module/rules";
...
interface RuleElementFormOptions<TSource extends RuleElementSource, TObject extends RuleElementXPRPG> {
    item: ItemXPRPG;
    index: number;
    rule: TSource;
    object: TObject | null;
...
class RuleElementForm<
    ...
    TObject extends RuleElementXPRPG = RuleElementXPRPG
> {
    template = "systems/xprpg/templates/items/rules/default.hbs";

    readonly item: ItemXPRPG;
...
type RuleElementFormSheetData<
    ...
    TObject extends RuleElementXPRPG
