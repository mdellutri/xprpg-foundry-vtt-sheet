...
export class SenseSelector<TActor extends ActorXPRPG> extends BaseTagSelector<TActor> {
    protected objectProperty = "system.traits.senses";

    static override get defaultOptions(): FormApplicationOptions {
        return mergeObject(super.defaultOptions, {
            template: "systems/xprpg/templates/system/tag-selector/senses.hbs",
            title: "XPRPG.Actor.Creature.Sense.Label",
        });
    }
    ...
    override async getData(): Promise<SenseSelectorData<TActor>> {
        if (!this.object.isOfType("character")) {
            throw ErrorXPRPG("The Sense selector is usable only with PCs");
        }
        ...
        return {
            ...
            hasExceptions: false,
            choices,
            senseAcuity: CONFIG.XPRPG.senseAcuity,
        };
    }
...
interface SenseSelectorData<TActor extends ActorXPRPG> extends FormApplicationData<TActor> {
