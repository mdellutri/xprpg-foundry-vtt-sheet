...
export function demoralize(options: SkillActionOptions) {
    ...
    ActionMacroHelpers.simpleRollActionCheck({
        ...
        title: "XPRPG.Actions.Demoralize.Title",
        ...
        extraNotes: (selector: string) => [
            ActionMacroHelpers.note(selector, "XPRPG.Actions.Demoralize", "criticalSuccess"),
            ActionMacroHelpers.note(selector, "XPRPG.Actions.Demoralize", "success"),
        ],
    });
}
