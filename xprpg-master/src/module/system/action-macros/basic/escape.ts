...
export function escape(options: SkillActionOptions) {
    ActionMacroHelpers.simpleRollActionCheck({
                ...
                options.skill && options.skill !== "unarmed"
                    ...
                    : (() => {
                          ...
                          const strikes = (() => {
                              ...
                              } else if (actor instanceof NPCXPRPG) {
                                  return actor.system.actions.filter((strike) =>
        ...
        title: "XPRPG.Actions.Escape.Title",
        traits: ["attack"],
        event: options.event,
        ...
        extraNotes: (selector: string) => [
            ActionMacroHelpers.note(selector, "XPRPG.Actions.Escape", "criticalSuccess"),
            ActionMacroHelpers.note(selector, "XPRPG.Actions.Escape", "success"),
            ActionMacroHelpers.note(selector, "XPRPG.Actions.Escape", "criticalFailure"),
        ],
    });
}
