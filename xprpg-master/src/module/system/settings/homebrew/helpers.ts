...
import { ItemSourceXPRPG, MeleeSource, WeaponSource } from "@item/data";
...
export function prepareCleanup(listKey: HomebrewTraitKey, deletions: string[]): MigrationBase {
    const Migration = class extends MigrationBase {
        ...
        override async updateActor(source: ActorSourceXPRPG) {
        ...
        override async updateItem(source: ItemSourceXPRPG) {
            switch (listKey) {
