...
const PERSISTENT_DAMAGE_IMAGES: Partial<Record<DamageType, ImageFilePath>> = {
    piercing: "systems/xprpg/icons/equipment/weapons/throwing-knife.webp",
    bludgeoning: "systems/xprpg/icons/equipment/weapons/bola.webp",
    slashing: "systems/xprpg/icons/equipment/weapons/scimitar.webp",
    fire: "systems/xprpg/icons/spells/flaming-sphere.webp",
    acid: "systems/xprpg/icons/spells/blister.webp",
    cold: "systems/xprpg/icons/spells/chilling-spray.webp",
    electricity: "systems/xprpg/icons/spells/chain-lightning.webp",
    sonic: "systems/xprpg/icons/spells/cry-of-destruction.webp",
    force: "systems/xprpg/icons/spells/magic-missile.webp",
    mental: "systems/xprpg/icons/spells/modify-memory.webp",
    poison: "systems/xprpg/icons/spells/acidic-burst.webp",
    lawful: "systems/xprpg/icons/equipment/adventuring-gear/merchant-scale.webp",
    chaotic: "systems/xprpg/icons/spells/dinosaur-form.webp",
    good: "systems/xprpg/icons/damage/persistent/good.webp",
    evil: "systems/xprpg/icons/spells/daemonic-pact.webp",
    positive: "systems/xprpg/icons/spells/moment-of-renewal.webp",
    negative: "systems/xprpg/icons/spells/grim-tendrils.webp",
};
