...
import { RollNoteXPRPG, RollNoteSource } from "@module/notes";
...
interface RollDataXPRPG extends RollOptions {
    rollerId?: string;
...
interface BaseRollContext {
    ...
    notes?: (RollNoteXPRPG | RollNoteSource)[];
...
export { BaseRollContext, DamageRollParams, RollDataXPRPG, RollParameters, RollTwiceOption, AttackRollParams };
