...
export class ActorDirectoryXPRPG<TDocument extends ActorXPRPG> extends ActorDirectory<TDocument> {
    ...
    override async getData(): Promise<object> {
        return {
            ...(await super.getData()),
            documentPartial: "systems/xprpg/templates/sidebar/actor-document-partial.hbs",
        };
    }
