...
export class ItemDirectoryXPRPG<TItem extends Item> extends ItemDirectory<TItem> {
    ...
    override async getData(): Promise<object> {
        return {
            ...(await super.getData()),
            documentPartial: "systems/xprpg/templates/sidebar/item-document-partial.hbs",
        };
    }
