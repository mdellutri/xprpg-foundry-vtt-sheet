...
export class CompendiumBrowserFeatTab extends CompendiumBrowserTab {
    ...
    override templatePath = "systems/xprpg/templates/compendium-browser/partials/feat.hbs";
    /* MiniSearch */
    ...
    protected override async loadData() {
        console.debug("XPRPG System | Compendium Browser | Started loading feats");
        ...
        const translatedSkills = Object.entries(CONFIG.XPRPG.skillList).reduce(
        ...
        // Filters
        this.filterData.checkboxes.feattype.options = this.generateCheckboxOptions(CONFIG.XPRPG.featTypes);
        this.filterData.checkboxes.skills.options = this.generateCheckboxOptions(CONFIG.XPRPG.skillList);
        this.filterData.checkboxes.rarity.options = this.generateCheckboxOptions(CONFIG.XPRPG.rarityTraits);
        this.filterData.checkboxes.source.options = this.generateSourceCheckboxOptions(sources);
        this.filterData.multiselects.traits.options = this.generateMultiselectOptions({ ...CONFIG.XPRPG.featTraits });

        console.debug("XPRPG System | Compendium Browser | Finished loading feats");
    }
    ...
    protected override prepareFilterData(): void {
        this.filterData = {
            checkboxes: {
                feattype: {
                    isExpanded: false,
                    label: "XPRPG.BrowserFilterCategory",
                    options: {},
                    selected: [],
                },
                skills: {
                    isExpanded: false,
                    label: "XPRPG.BrowserFilterSkills",
                    options: {},
                    selected: [],
                },
                rarity: {
