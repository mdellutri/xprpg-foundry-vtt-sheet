...
export class CompendiumBrowserActionTab extends CompendiumBrowserTab {
    ...
    override templatePath = "systems/xprpg/templates/compendium-browser/partials/action.hbs";
    /* MiniSearch */
    ...
    protected override async loadData() {
        console.debug("XPRPG System | Compendium Browser | Started loading actions");
        ...
        for await (const { pack, index } of this.browser.packLoader.loadPacks(
            ...
            console.debug(`XPRPG System | Compendium Browser | ${pack.metadata.label} - Loading`);
        ...
        // Set Filters
        this.filterData.multiselects.traits.options = this.generateMultiselectOptions(CONFIG.XPRPG.actionTraits);
        this.filterData.checkboxes.source.options = this.generateSourceCheckboxOptions(sources);

        console.debug("XPRPG System | Compendium Browser | Finished loading actions");
    }
