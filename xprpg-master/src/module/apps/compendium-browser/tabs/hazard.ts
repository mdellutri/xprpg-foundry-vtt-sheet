...
export class CompendiumBrowserHazardTab extends CompendiumBrowserTab {
    ...
    override templatePath = "systems/xprpg/templates/compendium-browser/partials/hazard.hbs";
    /* MiniSearch */
    ...
    protected override async loadData() {
        console.debug("XPRPG System | Compendium Browser | Started loading Hazard actors");
        ...
        for await (const { pack, index } of this.browser.packLoader.loadPacks(
            ...
            console.debug(`XPRPG System | Compendium Browser | ${pack.metadata.label} - Loaded`);
        }
        ...
        this.filterData.checkboxes.complexity.options = this.generateCheckboxOptions(
            {
                simple: "XPRPG.Actor.Hazard.Simple",
                complex: "XPRPG.TraitComplex",
            },
            false
        );
        this.filterData.multiselects.traits.options = this.generateMultiselectOptions(CONFIG.XPRPG.hazardTraits);
        this.filterData.checkboxes.rarity.options = this.generateCheckboxOptions(CONFIG.XPRPG.rarityTraits, false);
        this.filterData.checkboxes.source.options = this.generateSourceCheckboxOptions(sources);

        console.debug("XPRPG System | Compendium Browser | Finished loading Hazard actors");
    }
    ...
    protected override prepareFilterData(): void {
        this.filterData = {
            checkboxes: {
                complexity: {
                    isExpanded: true,
                    label: "XPRPG.BrowserFilterComplexity",
                    options: {},
                    selected: [],
                },
                rarity: {
