...
export class SceneDarknessAdjuster extends Application {
    ...
    static override get defaultOptions(): ApplicationOptions {
        return {
            ...
            template: "systems/xprpg/templates/system/scene-darkness-adjuster.hbs",
            width: 400,
            height: 45,
            minimizable: false,
        };
    ...
    override async render(force = false, options: RenderOptions & { scenes?: SceneXPRPG[] } = {}): Promise<this> {
