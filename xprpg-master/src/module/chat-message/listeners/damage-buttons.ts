...
class DamageButtons {
    static async listen(message: ChatMessageXPRPG, html: HTMLElement): Promise<void> {
    ...
    static #addListeners({ buttons, index, message }: AddListenersParams): void {
        ...
        if (shieldButton) {
            ...
            shieldButton.title = LocalizeXPRPG.translations.XPRPG.DamageButton.ShieldBlock;
        ...
        shieldButton?.addEventListener("click", async (event) => {
            ...
            if (multipleShields && !shieldActivated) {
                ...
                for (const shield of nonBrokenShields) {
                    ...
                    const hardnessLabel = LocalizeXPRPG.translations.XPRPG.ShieldHardnessLabel;
                ...
                $list.find("li input").on("change", (event) => {
                    ...
                    CONFIG.XPRPG.chatDamageButtonShieldToggle = true;
                });
            ...
            CONFIG.XPRPG.chatDamageButtonShieldToggle = !CONFIG.XPRPG.chatDamageButtonShieldToggle;
        });
    }
}
