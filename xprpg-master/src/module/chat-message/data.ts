...
interface ChatMessageDataXPRPG<TChatMessage extends ChatMessageXPRPG = ChatMessageXPRPG>
    extends foundry.data.ChatMessageData<TChatMessage> {
    readonly _source: ChatMessageSourceXPRPG;
}

interface ChatMessageSourceXPRPG extends foundry.data.ChatMessageSource {
    flags: ChatMessageFlagsXPRPG;
}

type ChatMessageFlagsXPRPG = foundry.data.ChatMessageFlags & {
    xprpg: {
...
export {
    ChatContextFlag,
    ChatMessageDataXPRPG,
    ChatMessageSourceXPRPG,
    ChatMessageFlagsXPRPG,
