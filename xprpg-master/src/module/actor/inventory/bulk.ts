...
export class InventoryBulk {
    ...
    static computeTotalBulk(items: PhysicalItemXPRPG[], actorSize: Size): Bulk {
    ...
    private static flattenNonStowing(items: PhysicalItemXPRPG[]): PhysicalItemXPRPG[] {
        return items
            .map((item) => {
