...
// For combatibility with the XPRPG Animal Companion Compendia module
const ANIMAL_COMPANION_SOURCE_ID = "Compendium.xprpg-animal-companions.AC-Ancestries-and-Class.h6Ybhv5URar01WPk";
const CONSTRUCT_COMPANION_SOURCE_ID = "Compendium.xprpg-animal-companions.AC-Features.OJePkZgnguu5Z8cA";
