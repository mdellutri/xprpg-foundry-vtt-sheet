...
import { AncestryXPRPG, BackgroundXPRPG, ClassXPRPG, DeityXPRPG, HeritageXPRPG } from "@item";
...
type CharacterSystemSheetData = CharacterSystemData & {
    ...
    details: CharacterSystemData["details"] & {
        keyability: {
            value: keyof typeof CONFIG.XPRPG.abilities;
...
interface CharacterSheetData extends CreatureSheetData<CharacterXPRPG> {
    abpEnabled: boolean;
