...
import { FeatXPRPG, HeritageXPRPG, WeaponXPRPG } from "@item";
...
interface CharacterData
    extends Omit<CharacterSource, "data" | "flags" | "effects" | "items" | "prototypeToken" | "system" | "type">,
        BaseCreatureData<CharacterXPRPG, "character", CharacterSource> {}

type CharacterFlags = ActorFlagsXPRPG & {
    xprpg: {
...
interface CharacterSystemData extends CreatureSystemData {
    ...
    /** Paragon Organized Play */
    xps: XenosParagonSocietyData;
...
type XenosParagonSocietyReputation = Record<PFSFaction, number | null>;

/** Paragon Organized Play data fields */
interface XenosParagonSocietyData {
    ...
    /** Character's Xenos Paragon school */
    school: PFSSchool;

    /** Character's Reputation with all the factions */
    reputation: XenosParagonSocietyReputation;
}
...
interface CharacterTraitsData extends CreatureTraitsData {
    senses: CreatureSenseXPRPG[];
}

interface GrantedFeat {
    feat: FeatXPRPG | HeritageXPRPG;
    grants: GrantedFeat[];
}
