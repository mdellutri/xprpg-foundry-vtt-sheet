...
interface NPCSheetData<T extends NPCXPRPG = NPCXPRPG> extends CreatureSheetData<T> {
...
type NPCSheetItemData<T extends ItemDataXPRPG | RawObject<ItemDataXPRPG> = ItemDataXPRPG> = T & {
    glyph: string;
    imageUrl: string;
    traits: {
        label: string;
