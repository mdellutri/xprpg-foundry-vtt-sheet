...
import { ActorAttributesSource, ActorFlagsXPRPG, ArmorClassData, PerceptionData, StrikeData } from "@actor/data/base";
...
interface NPCData
    extends Omit<NPCSource, "system" | "effects" | "items" | "prototypeToken" | "type">,
        BaseCreatureData<NPCXPRPG, "npc", NPCSource> {
    flags: NPCFlags;
}

type NPCFlags = ActorFlagsXPRPG & {
    xprpg: { lootable: boolean };
};
