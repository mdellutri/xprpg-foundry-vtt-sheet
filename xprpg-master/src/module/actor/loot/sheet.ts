...
import { LootSheetDataXPRPG } from "../sheet/data-types";
import { ItemXPRPG } from "@item";
import { DropCanvasItemDataXPRPG } from "@module/canvas/drop-canvas-data";

export class LootSheetXPRPG extends ActorSheetXPRPG<LootXPRPG> {
    ...
    override get template(): string {
        return "systems/xprpg/templates/actors/loot/sheet.hbs";
    }
    ...
    override async getData(): Promise<LootSheetDataXPRPG> {
    ...
    protected override async _onDropItem(
        ...
        itemData: DropCanvasItemDataXPRPG
    ): Promise<ItemXPRPG[]> {
