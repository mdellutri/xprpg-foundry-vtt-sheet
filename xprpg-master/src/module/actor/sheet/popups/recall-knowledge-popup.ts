...
export class RecallKnowledgePopup extends Application {
    static override get defaultOptions() {
        ...
        options.classes = [];
        options.title = game.i18n.localize("XPRPG.RecallKnowledge.BreakdownTitle");
        options.template = "systems/xprpg/templates/actors/recall-knowledge.hbs";
        options.width = 630;
        return options;
    }
    ...
    override async getData() {
        ...
        return {
            ...
            skills: Array.from(data.skills)
                .sort()
                .map((skill) => ({
                    name: CONFIG.XPRPG.skillList[skill],
