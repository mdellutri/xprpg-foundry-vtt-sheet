...
import { CheckModifier, DamageDiceXPRPG, ModifierXPRPG, RawModifier, StatisticModifier } from "@actor/modifiers";
...
import type { CreatureXPRPG } from ".";
import { CreatureSenseXPRPG, SenseAcuity, SenseType } from "./sense";
import { Alignment, CreatureTrait } from "./types";

type BaseCreatureSource<TType extends CreatureType, TSystemSource extends CreatureSystemSource> = BaseActorSourceXPRPG<
    TType,
    TSystemSource
>;

interface BaseCreatureData<
    TActor extends CreatureXPRPG,
...
> extends Omit<
        ...
        >,
        BaseActorDataXPRPG<TActor, TType, TSource> {}
...
type Language = keyof ConfigXPRPG["XPRPG"]["languages"];
type Attitude = keyof ConfigXPRPG["XPRPG"]["attitude"];
...
interface CreatureAttributes extends ActorAttributes {
    ...
    senses: { value: string } | CreatureSenseXPRPG[];
