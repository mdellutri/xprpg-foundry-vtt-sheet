...
class HearingSource<TObject extends TokenXPRPG> extends PointSource<TObject> {
...
interface HearingSource<TObject extends TokenXPRPG> extends PointSource<TObject> {
