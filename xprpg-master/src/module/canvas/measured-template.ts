import { MeasuredTemplateDocumentXPRPG } from "@module/scene/measured-template-document";
import { TemplateLayerXPRPG } from ".";
import { highlightGrid } from "./helpers";

class MeasuredTemplateXPRPG extends MeasuredTemplate<MeasuredTemplateDocumentXPRPG> {
...
interface MeasuredTemplateXPRPG extends MeasuredTemplate<MeasuredTemplateDocumentXPRPG> {
    get layer(): TemplateLayerXPRPG<this>;
}

export { MeasuredTemplateXPRPG };
