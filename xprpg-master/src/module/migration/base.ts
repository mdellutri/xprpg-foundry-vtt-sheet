...
interface MigrationBase {
     ...
     * @param source This should be effectively a `ActorSourceXPRPG` from the previous version.
     */
    updateActor?(source: ActorSourceXPRPG): Promise<void>;
     ...
     */
    preUpdateItem?(source: ItemSourceXPRPG, actorSource?: ActorSourceXPRPG): Promise<void>;
     ...
     */
    updateItem?(source: ItemSourceXPRPG, actorSource?: ActorSourceXPRPG): Promise<void>;
    ...
    updateToken?(
        ...
        scene: Readonly<SceneXPRPG | null>
    ): Promise<void>;
