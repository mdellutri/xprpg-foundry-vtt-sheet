...
export class Migration605CatchUpToTemplateJSON extends MigrationBase {
    ...
    private addEffects(entityData: ActorSourceXPRPG | ItemSourceXPRPG): void {
    ...
    override async updateItem(itemData: ItemSourceXPRPG, actorData: ActorSourceXPRPG): Promise<void> {
