        ...
        effects: [
            {
                affects: "allies",
                events: ["enter"],
                uuid: "Compendium.xprpg.feat-effects.FPuICuxBLiDaEbDX",
            },
        ],
        key: "Aura",
        radius: 15,
        ...
        effects: [
            {
                affects: "allies",
                events: ["enter"],
                uuid: "Compendium.xprpg.feat-effects.XM1AA8z5cHm8sJXM",
            },
        ],
        key: "Aura",
        radius: 15,
            ...
            effects: [
                {
                    affects: "allies",
                    events: ["enter"],
                    uuid: "Compendium.xprpg.spell-effects.Gqy7K6FnbLtwGpud",
                },
            ],
            key: "Aura",
            predicate: {
        ...
        effects: [
            {
                affects: "allies",
                events: ["enter"],
                uuid: "Compendium.xprpg.feat-effects.Ru4BNABCZ0hUbX7S",
            },
        ],
        key: "Aura",
        radius: 10,
