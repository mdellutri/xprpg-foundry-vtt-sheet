import { ArmorSource, ItemSourceXPRPG } from "@item/data";
...
export class Migration729CumulativeItemBonusCleanup extends MigrationBase {
    ...
    private isExplorersClothing(source: ItemSourceXPRPG): source is ArmorSource {
        return source.type === "armor" && this.#explorersClothingVariants.has(source.system.slug ?? "");
    }

    private isStanceEffectOrAnimalSkinFeat(source: ItemSourceXPRPG): boolean {
        return (
