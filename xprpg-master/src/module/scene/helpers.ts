...
import { TokenDocumentXPRPG } from "./token-document";
...
const checkAuras = foundry.utils.debounce(async function (this: SceneXPRPG): Promise<void> {
    ...
    const tokens = this.tokens.reduce((list: Embedded<TokenDocumentXPRPG>[], token) => {
