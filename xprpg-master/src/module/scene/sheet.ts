...
export class SceneConfigXPRPG<TScene extends SceneXPRPG> extends SceneConfig<TScene> {
    ...
    override activateListeners($html: JQuery): void {
        ...
        if (game.settings.get("xprpg", "automation.rulesBasedVision") && this.document.tokenVision) {
            ...
            if (!(globalLight && hasglobalThreshold && globalLightThreshold)) throw ErrorXPRPG("");
            ...
            for (const input of [globalLight, globalLightThreshold]) {
                ...
                managedBy.innerHTML = " ".concat(
                    game.i18n.localize("XPRPG.SETTINGS.Automation.RulesBasedVision.ManagedBy")
                );
