...
import { CreatureSenseXPRPG } from "@actor/creature/sense";
import { DamageDiceXPRPG, DeferredPromise, DeferredValue, ModifierAdjustment, ModifierXPRPG } from "@actor/modifiers";
...
interface RuleElementSynthetics {
    ...
    rollNotes: Record<string, RollNoteXPRPG[]>;
    ...
    strikes: Map<string, Embedded<WeaponXPRPG>>;
...
type CritSpecEffect = (DamageDiceXPRPG | ModifierXPRPG | RollNoteXPRPG)[];
type CritSpecSynthetic = (weapon: WeaponXPRPG | MeleeXPRPG, options: Set<string>) => CritSpecEffect | null;
...
type DeferredModifier = DeferredValue<ModifierXPRPG>;
type DeferredDamageDice = DeferredValue<DamageDiceXPRPG>;
...
interface StrikeAdjustment {
    ...
    adjustWeapon?: (weapon: WeaponXPRPG | MeleeXPRPG) => void;
    adjustTraits?: (weapon: WeaponXPRPG | MeleeXPRPG, traits: ActionTrait[]) => void;
}
