...
class SubstituteRollRuleElement extends RuleElementXPRPG {
    selector = "check";
    ...
    constructor(data: SubstituteRollSource, item: Embedded<ItemXPRPG>, options?: RuleElementOptions) {
...
interface SubstituteRollRuleElement extends RuleElementXPRPG {
    slug: string;
}
