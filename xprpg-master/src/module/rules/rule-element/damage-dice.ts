...
import { DamageDiceOverride, DamageDiceXPRPG, DeferredValueParams } from "@actor/modifiers";
...
import { RuleElementData, RuleElementXPRPG } from "./";
import { BracketedValue, RuleElementSource } from "./data";

class DamageDiceRuleElement extends RuleElementXPRPG {
    ...
    constructor(data: DamageDiceSource, item: Embedded<ItemXPRPG>) {
        super(data, item);
    ...
    override beforePrepareData(): void {
        ...
        const deferredDice = (params: DeferredValueParams = {}): DamageDiceXPRPG | null => {
            ...
            if (this.override) {
                ...
                if ("damageType" in this.override && !objectHasKey(CONFIG.XPRPG.damageTypes, this.override.damageType)) {
