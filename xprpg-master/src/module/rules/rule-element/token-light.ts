 ...
 */
class TokenLightRuleElement extends RuleElementXPRPG {
    constructor(data: RuleElementSource, item: Embedded<ItemXPRPG>, options?: RuleElementOptions) {
...
interface TokenLightRuleElement extends RuleElementXPRPG {
    data: TokenLightData;
}
