...
import { RuleElementXPRPG } from "./base";
...
abstract class WithItemAlterations<TSchema extends RuleElementSchema> {
    static apply<TSchema extends RuleElementSchema>(Class: typeof RuleElementXPRPG<TSchema>): void {
    ...
    itemCanBeAltered(this: RuleElementXPRPG, source: ItemSourceXPRPG, value: unknown): boolean | null {
    ...
    applyAlterations(this: WithItemAlterations<TSchema>, itemSource: ItemSourceXPRPG): void {
...
interface WithItemAlterations<TSchema extends RuleElementSchema> extends RuleElementXPRPG<TSchema> {
