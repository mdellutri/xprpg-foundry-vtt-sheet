...
export class LoseHitPointsRuleElement extends RuleElementXPRPG {
    ...
    constructor(data: LoseHitPointsSource, item: Embedded<ItemXPRPG>, options?: RuleElementOptions) {
    ...
    override async preUpdate(changes: DeepPartial<ItemSourceXPRPG>): Promise<void> {
...
export interface LoseHitPointsRuleElement extends RuleElementXPRPG {
