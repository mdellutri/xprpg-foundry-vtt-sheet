...
import { ItemXPRPG, MeleeXPRPG, WeaponXPRPG } from "@item";
...
import { ErrorXPRPG, objectHasKey, sluggify } from "@util";
...
class AdjustStrikeRuleElement extends AELikeRuleElement<AdjustStrikeSchema> {
    ...
    constructor(data: AdjustStrikeSource, item: Embedded<ItemXPRPG>, options?: RuleElementOptions) {
    ...
    override applyAELike(): void {
        ...
        const adjustment = ((): StrikeAdjustment => {
            if (!this.property) throw ErrorXPRPG("Unexpected error applying adjustment");
                ...
                case "materials":
                    return {
                        adjustDamageRoll: (
                            ...
                            if (!objectHasKey(CONFIG.XPRPG.materialDamageEffects, change)) {
                ...
                case "traits":
                    return {
                        adjustTraits: (weapon: WeaponXPRPG | MeleeXPRPG, traits: ActionTrait[]): void => {
                            ...
                            if (!objectHasKey(CONFIG.XPRPG.actionTraits, change)) {
                ...
                case "weapon-traits":
                    return {
                        adjustWeapon: (weapon: WeaponXPRPG | MeleeXPRPG): void => {
                            ...
                            if (!objectHasKey(CONFIG.XPRPG.weaponTraits, change)) {
                ...
                case "property-runes":
                    return {
                        adjustWeapon: (weapon: WeaponXPRPG | MeleeXPRPG): void => {
                            ...
                            if (!objectHasKey(CONFIG.XPRPG.weaponPropertyRunes, runeSlug)) {
