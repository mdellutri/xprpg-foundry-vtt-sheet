 ...
 */
class CraftingEntryRuleElement extends RuleElementXPRPG {
    protected static override validActorTypes: ActorType[] = ["character"];

    private selector: string;

    constructor(data: CraftingEntryRuleSource, item: Embedded<ItemXPRPG>, options?: RuleElementOptions) {
    ...
    override beforePrepareData(): void {
        ...
        if (!PredicateXPRPG.isValid(craftableItems)) {
...
interface CraftingEntryRuleElement extends RuleElementXPRPG {
