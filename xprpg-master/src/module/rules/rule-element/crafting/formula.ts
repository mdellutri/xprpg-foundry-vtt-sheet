 ...
 */
class CraftingFormulaRuleElement extends RuleElementXPRPG {
    protected static override validActorTypes: ActorType[] = ["character"];

    constructor(data: CraftingFormulaSource, item: Embedded<ItemXPRPG>, options?: RuleElementOptions) {
...
interface CraftingFormulaRuleElement extends RuleElementXPRPG {
