...
import { RuleElementData, RuleElementOptions, RuleElementXPRPG, RuleElementSource } from "./";

/**
 * @category RuleElement
 */
class AdjustDegreeOfSuccessRuleElement extends RuleElementXPRPG {
    selector: string;

    constructor(data: AdjustDegreeOfSuccessSource, item: Embedded<ItemXPRPG>, options?: RuleElementOptions) {
