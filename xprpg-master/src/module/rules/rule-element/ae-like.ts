 ...
 */
class AELikeRuleElement<TSchema extends AELikeSchema> extends RuleElementXPRPG<TSchema> {
    constructor(data: AELikeSource, item: Embedded<ItemXPRPG>, options?: RuleElementOptions) {
