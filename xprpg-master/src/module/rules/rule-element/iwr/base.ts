import { RuleElementXPRPG, RuleElementSource, RuleElementOptions, RuleElementSchema } from "../";
...
abstract class IWRRuleElement<TSchema extends IWRRuleSchema> extends RuleElementXPRPG<TSchema> {
    constructor(data: IWRRuleElementSource, item: Embedded<ItemXPRPG>, options?: RuleElementOptions) {
    ...
    #isValid(value: unknown): boolean {
        ...
        if (dictionary !== CONFIG.XPRPG.immunityTypes && (typeof value !== "number" || value < 0)) {
...
interface IWRRuleElement<TSchema extends IWRRuleSchema>
    extends RuleElementXPRPG<TSchema>,
