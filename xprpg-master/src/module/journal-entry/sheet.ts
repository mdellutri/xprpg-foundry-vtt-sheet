...
class JournalSheetXPRPG<TJournalEntry extends JournalEntry = JournalEntry> extends JournalSheet<TJournalEntry> {
...
class JournalTextTinyMCESheetXPRPG extends JournalTextTinyMCESheet {
...
export { JournalSheetXPRPG, JournalTextTinyMCESheetXPRPG };
